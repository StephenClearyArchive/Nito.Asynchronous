...
namespace Client
{
    public partial class FormClientMain : Form
    {
        ...
        /// </summary>
        private ClientTcpSocket ClientSocket;
        ...
        /// <summary>
        /// The reader that is constantly receiving and formatting packets from ClientSocket. This is null if
        ///  ClientSocketState is SocketState.Closed or SocketState.Connecting.
        /// </summary>
        private SocketPacketProtocol ClientSocketReader;
        ...
        private void ClientSocket_ConnectCompleted(AsyncCompletedEventArgs e)
        {
            try
            {
                ...
                ClientSocketReader.Start();
            }
            catch (Exception ex)
            {
                ResetSocket();
                textBoxLog.AppendText("Socket error during Read: [" + ex.GetType().Name + "] " + ex.Message + Environment.NewLine);
            }
            finally
            {
                RefreshDisplay();
        ...
        private void ClientSocket_WriteCompleted(AsyncCompletedEventArgs e)
        {
            // Check for errors
            if (e.Error != null)
            {
